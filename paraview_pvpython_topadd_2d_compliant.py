...
def main(iterNum):
    ...
    if (exists(fileName)):
        ...
        reflect1 = Reflect(Input=reader)
	# Properties modified on reflect
        ...
        SaveScreenshot(saveFileName, ImageResolution=[7680, 4320])
...
#        Render() 
        ...
        cleantoGrid1 = CleantoGrid(Input=reflect1)
